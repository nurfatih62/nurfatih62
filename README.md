...
|---|---|---|
| 🧾 **Digital Financing System** | Laravel | Sistem pembiayaan digital dengan RBAC & dashboard analisis real-time. |
| 🧮 **MathNesia** | Laravel 12 | Platform belajar matematika interaktif — XP, level, leaderboard, daily streak. |
| ☕ **Cafe ESEMKA** | Flutter | Aplikasi manajemen & pemesanan kafe — meja, transaksi, laporan penjualan. |
